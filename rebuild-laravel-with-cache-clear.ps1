...
if ($LASTEXITCODE -eq 0) {
    Write-Host "[SUCCESS] Laravel frontend build completed successfully!" -ForegroundColor Green
    ...
    Write-Host ""
    Write-Host "[COMPLETE] Laravel cache clearing and rebuild complete!" -ForegroundColor Green
