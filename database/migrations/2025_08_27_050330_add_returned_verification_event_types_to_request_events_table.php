...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $newValues = ['returned_verified', 'returned_rejected'];
        $allValues = array_merge($currentEnumValues, $newValues);
    ...
    public function down(): void
    {
        ...
        // Remove new values
        $remainingValues = array_diff($currentEnumValues, ['returned_verified', 'returned_rejected']);
