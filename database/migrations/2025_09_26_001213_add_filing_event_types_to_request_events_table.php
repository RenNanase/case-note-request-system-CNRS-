...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $newValues = ['filing_submitted', 'filing_approved', 'filing_rejected'];
    ...
    public function down(): void
    {
        ...
        // Remove new values
        $remainingValues = array_diff($currentEnumValues, ['filing_submitted', 'filing_approved', 'filing_rejected']);
